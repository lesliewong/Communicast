...
import org.communicast.msg.HelloWorld;
import org.communicast.msg.Registry;
import org.communicast.net.ListenSuccessEvent;
...
//		node9.connect(node4.getServerAddress(), node4.getServerPort());
		...
		for (int i = 0 ; i < 10; i++) {
			node6.broadcast(new HelloWorld("广播消息" + (i+1)));
		}
		System.out.println("广播已执行");
//		
//		//从节点9广播一条消息,消息可被8收到
